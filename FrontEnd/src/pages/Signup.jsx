            ...
            <main className="flex-1 flex items-center justify-center p-6 min-h-screen">
                <div className="w-full max-w-[420px] animate-fade-in-up">
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-1.5">
                                <div className="flex justify-between items-baseline">
                                    <label className="block text-xs font-medium text-zinc-400 uppercase tracking-wider" htmlFor="email">Email</label>
                            ...
                            <p className="text-xs text-center text-zinc-500 mt-5 leading-relaxed">
                                ...
                                <a className="text-zinc-400 hover:text-white underline underline-offset-2 transition-colors ml-1" href="#">Terms</a>
                                and
                                <a className="text-zinc-400 hover:text-white underline underline-offset-2 transition-colors ml-1" href="#">Privacy Policy</a>.
                            </p>
                        </form>
                    ...
                    <div className="mt-8 text-center text-sm text-zinc-500">
                        ...
                        <Link className="text-primary hover:text-primary-hover font-medium transition-colors ml-1" to="/login">
                            Log in
                        </Link>
                    </div>
                </div>
